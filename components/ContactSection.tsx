...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="connect" className="py-24 md:py-36 bg-warm-bg relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 bg-warm-surface border border-ink-dark/10 p-8 md:p-12 shadow-tactile space-y-8">
            <div className="border-b border-ink-dark/10 pb-6">
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <ArrowUpRight className="w-4 h-4 text-ink-muted group-hover:text-kavibe-primary group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" />
              </a>
            ...
            <div className="pt-4 flex items-center justify-between text-xs font-sans text-ink-muted border-t border-ink-dark/10">
