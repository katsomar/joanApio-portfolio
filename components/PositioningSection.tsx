...
export const PositioningSection: React.FC = () => {
  ...
  return (
    <section className="py-14 md:py-32 bg-warm-surface border-y border-ink-dark/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-4 md:space-y-6">
            ...
            <CinematicReveal variant="words" delay={0.2}>
              <div className="relative">
                ...
                <blockquote className="font-serif text-2xl sm:text-4xl md:text-5xl font-light text-ink-dark leading-[1.25]">
            ...
            <CinematicReveal variant="fade-up" delay={0.4}>
              <div className="flex items-center gap-2.5 sm:gap-4 pt-2 sm:pt-4">
                <div className="w-6 sm:w-12 h-[1px] bg-kavibe-primary flex-shrink-0" />
                <cite className="font-sans text-[10px] sm:text-xs md:text-sm font-semibold tracking-wider text-ink-dark not-italic uppercase whitespace-nowrap">
          ...
          {/* Pillars List (Hidden on mobile to prevent clutter, visible on laptop/desktop) */}
          <div className="hidden lg:block lg:col-span-4 space-y-6 border-l border-ink-dark/10 lg:pl-12">
