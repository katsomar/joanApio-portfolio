        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
            <div className="lg:col-span-8 space-y-4">
              ...
              <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl text-ink-dark font-normal">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="aspect-[4/5] relative overflow-hidden bg-ink-dark/5 border border-ink-dark/10 shadow-elevated group">
                <Image
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {projects.map((project) => (
              <div key={project.id} className="bg-warm-bg border border-ink-dark/10 p-8 shadow-tactile space-y-6 flex flex-col justify-between group">
                <div>
                  <div className="aspect-[16/9] relative overflow-hidden bg-ink-dark/5 border border-ink-dark/10 mb-6">
                    <Image
                      src={project.image}
                      alt={project.title}
                      fill
      ...
      <section id="journey" className="py-24 bg-warm-bg border-b border-ink-dark/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-12 max-w-4xl">
            {journey.map((item) => (
              <div key={item.organization} className="p-8 bg-warm-surface border border-ink-dark/10 shadow-tactile space-y-4">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              <span className="font-sans text-xs uppercase tracking-superwide text-kavibe-accent font-semibold block">
            ...
            <div className="lg:col-span-6 bg-warm-bg/5 border border-warm-bg/10 p-8 md:p-12 space-y-6">
