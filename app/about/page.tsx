        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              <div className="aspect-[3/4] relative overflow-hidden bg-ink-dark/5 border border-ink-dark/10 shadow-elevated group">
                <Image
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <blockquote className="p-8 bg-warm-surface border-l-4 border-kavibe-primary my-8 space-y-4">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="bg-ink-dark text-warm-bg p-8 space-y-4">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {projects.map((project) => (
              <div key={project.id} className="p-8 bg-warm-bg border border-ink-dark/10 space-y-4 shadow-tactile">
                ...
                <div className="pt-2 border-t border-ink-dark/10 text-xs font-sans text-ink-muted">
      ...
      <section className="py-24 bg-warm-bg border-b border-ink-dark/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          ...
          <div className="space-y-8 max-w-4xl">
            {journey.map((item) => (
              <div key={item.organization} className="p-8 bg-warm-surface border border-ink-dark/10 space-y-3">
